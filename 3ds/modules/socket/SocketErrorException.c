...
STATIC mp_obj_t mod_socket_exception_error_make_new(const mp_obj_type_t *type, size_t n_args, size_t n_kw, const mp_obj_t *args) {
...
const mp_obj_type_t mod_socket_exception_error_type = {
        ...
        .make_new = mod_socket_exception_error_make_new,
